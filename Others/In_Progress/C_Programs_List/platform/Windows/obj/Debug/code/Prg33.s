...
_Prg33:
LFB13:
	.file 1 "G:/My_SVN/Git/MyPrograms/Others/In_Progress/C_Programs_List/platform/Windows/../../code/Prg33.c"
	.loc 1 16 1
	.cfi_startproc
	pushl	%ebp
...
L5:
	...
	jmp	L3
L4:
	.loc 1 34 31 discriminator 3
	movl	-12(%ebp), %eax
	leal	(%eax,%eax), %edx
	movl	-16(%ebp), %eax
	addl	%edx, %eax
	movl	-40(%ebp,%eax,4), %ecx
	.loc 1 34 20 discriminator 3
	movl	-16(%ebp), %edx
	movl	%edx, %eax
	addl	%eax, %eax
	addl	%edx, %eax
...
Ldebug_info0:
	...
	.byte	0xc
	.ascii "g:\\my_svn\\git\\myprograms\\others\\in_progress\\c_programs_list\\code\\prg33.c\0"
