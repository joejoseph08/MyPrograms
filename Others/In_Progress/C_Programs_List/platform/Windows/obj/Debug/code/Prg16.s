...
_Prg16:
LFB13:
	.file 1 "G:/My_SVN/Git/MyPrograms/Others/In_Progress/C_Programs_List/platform/Windows/../../code/Prg16.c"
	.loc 1 7 1
	.cfi_startproc
	pushl	%ebp
...
L3:
	...
	movl	$LC0, (%esp)
	call	_printf
	.loc 1 15 15 discriminator 3
	movzbl	-10(%ebp), %edx
	movzbl	-9(%ebp), %eax
	addl	%edx, %eax
	.loc 1 15 9 discriminator 3
	movb	%al, -10(%ebp)
	.loc 1 12 23 discriminator 3
	movzbl	-9(%ebp), %eax
	addl	$1, %eax
	movb	%al, -9(%ebp)
L2:
...
Ldebug_info0:
	...
	.byte	0xc
	.ascii "g:\\my_svn\\git\\myprograms\\others\\in_progress\\c_programs_list\\code\\prg16.c\0"
