# 1 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\main.c"
# 1 "G:\\My_SVN\\Git\\MyPrograms\\Others\\In_Progress\\Card_Game_Hearts\\platform\\Windows//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "G:\\My_SVN\\Git\\MyPrograms\\Others\\In_Progress\\Card_Game_Hearts\\platform\\Windows\\..\\..\\code\\Main.c"
# 1 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Main.h" 1
...
# 6 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Main.h" 2
# 1 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Typedef.h" 1




    
# 5 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Typedef.h"
...
# 7 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Main.h" 2
# 1 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Macro.h" 1
# 8 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Main.h" 2
# 1 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Extern.h" 1



    extern _Total Total[52];
    extern U8 Card_Pass_Routine(U8);
    extern void Read_User_Cards(U8);
    extern void Display_User_Cards(U8);
# 9 "g:\\my_svn\\git\\myprograms\\others\\in_progress\\card_game_hearts\\code\\Main.h" 2



    _Total Total[52] = {

                          {0x10, 13, 0, 0x55, 0x55, (0x10 | 0x02), "H2"},
                          {0x10, 12, 1, 0x55, 0x55, (0x10 | 0x03), "H3"},
                          {0x10, 11, 2, 0x55, 0x55, (0x10 | 0x04), "H4"},
                          {0x10, 10, 3, 0x55, 0x55, (0x10 | 0x05), "H5"},
                          {0x10, 9, 4, 0x55, 0x55, (0x10 | 0x06), "H6"},
                          {0x10, 8, 5, 0x55, 0x55, (0x10 | 0x07), "H7"},
                          {0x10, 7, 6, 0x55, 0x55, (0x10 | 0x08), "H8"},
                          {0x10, 6, 7, 0x55, 0x55, (0x10 | 0x09), "H9"},
                          {0x10, 5, 8, 0x55, 0x55, (0x10 | 0x0A), "H10"},
                          {0x10, 4, 9, 0x55, 0x55, (0x10 | 0x0B), "HJ"},
                          {0x10, 3, 10, 0x55, 0x55, (0x10 | 0x0C), "HQ"},
                          {0x10, 2, 11, 0x55, 0x55, (0x10 | 0x0D), "HK"},
                          {0x10, 1, 12, 0x55, 0x55, (0x10 | 0x0E), "HA"},


                          {0x20, 13, 13, 0x55, 0x55, (0x20 | 0x02), "S2"},
                          {0x20, 12, 14, 0x55, 0x55, (0x20 | 0x03), "S3"},
                          {0x20, 11, 15, 0x55, 0x55, (0x20 | 0x04), "S4"},
                          {0x20, 10, 16, 0x55, 0x55, (0x20 | 0x05), "S5"},
                          {0x20, 9, 17, 0x55, 0x55, (0x20 | 0x06), "S6"},
                          {0x20, 8, 18, 0x55, 0x55, (0x20 | 0x07), "S7"},
                          {0x20, 7, 19, 0x55, 0x55, (0x20 | 0x08), "S8"},
                          {0x20, 6, 20, 0x55, 0x55, (0x20 | 0x09), "S9"},
                          {0x20, 5, 21, 0x55, 0x55, (0x20 | 0x0A), "S10"},
                          {0x20, 4, 22, 0x55, 0x55, (0x20 | 0x0B), "SJ"},
                          {0x20, 3, 23, 0x55, 0x55, (0x20 | 0x0C), "SQ"},
                          {0x20, 2, 24, 0x55, 0x55, (0x20 | 0x0D), "SK"},
                          {0x20, 1, 25, 0x55, 0x55, (0x20 | 0x0E), "SA"},


                          {0x30, 13, 26, 0x55, 0x55, (0x30 | 0x02), "C2"},
                          {0x30, 12, 27, 0x55, 0x55, (0x30 | 0x03), "C3"},
                          {0x30, 11, 28, 0x55, 0x55, (0x30 | 0x04), "C4"},
                          {0x30, 10, 29, 0x55, 0x55, (0x30 | 0x05), "C5"},
                          {0x30, 9, 30, 0x55, 0x55, (0x30 | 0x06), "C6"},
                          {0x30, 8, 31, 0x55, 0x55, (0x30 | 0x07), "C7"},
                          {0x30, 7, 32, 0x55, 0x55, (0x30 | 0x08), "C8"},
                          {0x30, 6, 33, 0x55, 0x55, (0x30 | 0x09), "C9"},
                          {0x30, 5, 34, 0x55, 0x55, (0x30 | 0x0A), "C10"},
                          {0x30, 4, 35, 0x55, 0x55, (0x30 | 0x0B), "CJ"},
                          {0x30, 3, 36, 0x55, 0x55, (0x30 | 0x0C), "CQ"},
                          {0x30, 2, 37, 0x55, 0x55, (0x30 | 0x0D), "CK"},
                          {0x30, 1, 38, 0x55, 0x55, (0x30 | 0x0E), "CA"},


                          {0x40, 13, 39, 0x55, 0x55, (0x40 | 0x02), "D2"},
                          {0x40, 12, 40, 0x55, 0x55, (0x40 | 0x03), "D3"},
                          {0x40, 11, 41, 0x55, 0x55, (0x40 | 0x04), "D4"},
                          {0x40, 10, 42, 0x55, 0x55, (0x40 | 0x05), "D5"},
                          {0x40, 9, 43, 0x55, 0x55, (0x40 | 0x06), "D6"},
                          {0x40, 8, 44, 0x55, 0x55, (0x40 | 0x07), "D7"},
                          {0x40, 7, 45, 0x55, 0x55, (0x40 | 0x08), "D8"},
                          {0x40, 6, 46, 0x55, 0x55, (0x40 | 0x09), "D9"},
                          {0x40, 5, 47, 0x55, 0x55, (0x40 | 0x0A), "D10"},
                          {0x40, 4, 48, 0x55, 0x55, (0x40 | 0x0B), "DJ"},
                          {0x40, 3, 49, 0x55, 0x55, (0x40 | 0x0C), "DQ"},
                          {0x40, 2, 50, 0x55, 0x55, (0x40 | 0x0D), "DK"},
                          {0x40, 1, 51, 0x55, 0x55, (0x40 | 0x0E), "DA"}
                        };
# 2 "G:\\My_SVN\\Git\\MyPrograms\\Others\\In_Progress\\Card_Game_Hearts\\platform\\Windows\\..\\..\\code\\Main.c" 2



int main()
{
  Read_User_Cards(0x01);
  Display_User_Cards(0x01);
  getchar();;
