# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.c"
# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.c"
# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.h" 1
...
# 1 "/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/stdarg.h" 3 4
...
# 1 "/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/stdint.h" 1 3 4
# 9 "/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/stdint.h" 3 4
...
# 10 "/usr/lib/gcc/i686-pc-cygwin/4.8.3/include/stdint.h" 2 3 4
...
# 5 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.h" 2
...
# 6 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.h" 2
# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Typedef.h" 1



# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Macro.h" 1
# 5 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Typedef.h" 2
...
# 7 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.h" 2
# 1 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Extern.h" 1
# 9 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Extern.h"
...
# 8 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.h" 2
...
# 2 "/cygdrive/f/My_SVN/Google_Drive/Official/Others/Programs/Others/Completed/Singly_Linked_List/platform/Linux/../../code/Singly_Linked_List.c" 2

S_New_Node* S_Create_Node(S_New_Node *Data_Node)
{
  S_New_Node *Current_Node = ((void *)0);
...
U8 S_Delete_End(void)
{
  ...
  if(Ptr_Node_1 == ((void *)0))
    return 0;
  else if(Ptr_Node_1->Next == ((void *)0))
  {
    S_Head_Node = ((void *)0);
    free(Ptr_Node_1);
    return 1;
  ...
  {
    while(Ptr_Node_2->Next != ((void *)0))
    {
      Ptr_Node_1 = Ptr_Node_2;
      Ptr_Node_2 = Ptr_Node_2->Next;
    }
    Ptr_Node_1->Next = ((void *)0);
    free(Ptr_Node_2);
  }
  return 1;
}
...
U8 S_Remove_Duplicates(void)
{
  ...
  {
    while(Ptr_Node_1 != ((void *)0))
    {
      while(Ptr_Node_2 != ((void *)0))
      {
